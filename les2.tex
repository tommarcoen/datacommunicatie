...
\item Neem twee desktop computers en verbind deze met een Cisco Catalyst 2960-switch.
   ...
   \end{itemize}
\item Geef beide computers een IP-adres in hetzelfde netwerk. Kies zelf het netwerkadres maar gebruik het subnet masker 255.255.255.0. Het is niet nodig een default gateway in te vullen.
